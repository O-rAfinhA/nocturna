...
<link rel="stylesheet" href="/styles.css"><script type="module" src="/comments.js"></script>
...
<script type="application/ld+json">${structured}</script><link rel="stylesheet" href="/styles.css"></head>
