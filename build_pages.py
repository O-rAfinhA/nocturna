...
ANALYTICS_SCRIPT = '<script>window.va=window.va||function(){(window.vaq=window.vaq||[]).push(arguments)};</script><script defer src="/_vercel/insights/script.js"></script>'
HOME_META = {
...
PRIVACY = {
    ...
    "es": {
        ...
        "h5": "Medición de visitas y publicidad", "p5": "El sitio usa Vercel Web Analytics para contar visitas de forma agregada, sin cookies de análisis ni identificación individual de visitantes. La medición puede incluir la página visitada, el origen de la visita, el país aproximado y datos técnicos del navegador; Vercel procesa estos datos. Google Analytics y Google AdSense no están activos.",
...
for lang in ("pt", "en", "es"):
    ...
    if not STATIC_CATALOG:
        ...
        page = page.replace('</head>', f'{ANALYTICS_SCRIPT}</head>', 1)
...
<html lang="{locale}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">{privacy_meta}<meta name="theme-color" content="#080d14"><title>{escape(copy['title'])} — Nocturna</title><link rel="stylesheet" href="../styles.css">{ANALYTICS_SCRIPT if not STATIC_CATALOG else ''}</head>
