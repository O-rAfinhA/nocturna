...
PRIVACY = {
    "pt": {
        "title": "Privacidade", "back": "Voltar ao atlas", "status": "Os dados públicos de contato do responsável serão acrescentados aqui.",
        ...
        "h5": "Medição de visitas, publicidade e contato", "p5": "O site usa Vercel Web Analytics para contar visitas de forma agregada, sem cookies de análise e sem identificar visitantes individualmente. A medição pode incluir a página acessada, origem da visita, país aproximado e dados técnicos do navegador; esses dados são processados pela Vercel. Google Analytics e Google AdSense não estão ativos. Os dados públicos de contato do responsável serão divulgados nesta página quando definidos.",
    },
    "en": {
        "title": "Privacy", "back": "Back to the atlas", "status": "The site owner's public contact details will be added here.",
        ...
        "h5": "Visit measurement, ads and contact", "p5": "The site uses Vercel Web Analytics to count visits in aggregate, without analytics cookies or individually identifying visitors. Measurement may include the page visited, referral source, approximate country and browser technical data; Vercel processes this data. Google Analytics and Google AdSense are not active. The site owner's public contact details will be added to this page when defined.",
    },
    "es": {
        "title": "Privacidad", "back": "Volver al atlas", "status": "Los datos públicos de contacto del responsable se añadirán aquí.",
        ...
        "h5": "Medición de visitas, publicidad y contacto", "p5": "El sitio usa Vercel Web Analytics para contar visitas de forma agregada, sin cookies de análisis ni identificación individual de visitantes. La medición puede incluir la página visitada, el origen de la visita, el país aproximado y datos técnicos del navegador; Vercel procesa estos datos. Google Analytics y Google AdSense no están activos. Los datos públicos de contacto del responsable se añadirán a esta página cuando se definan.",
    },
}
LOCAL_PRIVACY_ANALYTICS = {
    "pt": "Esta versão local não inclui medição de visitas nem anúncios. Google Analytics e Google AdSense não estão ativos. Os dados públicos de contato do responsável serão divulgados nesta página quando definidos.",
    "en": "This local version does not include visit measurement or ads. Google Analytics and Google AdSense are not active. The site owner's public contact details will be added to this page when defined.",
    "es": "Esta versión local no incluye medición de visitas ni anuncios. Google Analytics y Google AdSense no están activos. Los datos públicos de contacto del responsable se añadirán a esta página cuando se definan.",
}
...
<html lang="{locale}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="robots" content="noindex,follow"><meta name="theme-color" content="#080d14"><title>{escape(copy['title'])} — Nocturna</title><link rel="stylesheet" href="../styles.css">{ANALYTICS_SCRIPT if not STATIC_CATALOG else ''}</head>
